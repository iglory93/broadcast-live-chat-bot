...
async function handleCommand(chat) {
  ...
  //   await sendChat(
  //       channelId,
  //       `🎁 ${nickname}님께서 ${amount}${productName} 선물을 했습니다! 감사합니다 💖`
  //   );
  ...
  if (chat.type === "chat") {
    ...
    try {
      ...
      /* 명령어 추가 */
       ...
       // if( master === 999846 || master === 981141 ) {
        ...
        commandStore.addGlobal(key, value);
    ...
    /* 채널 명령어 추가 */
        ...
        if (master === "999846" || master === "981141" || master === channelId) {
            ...
            commandStore.addChannel(channelId, key, value);
    ...
    /* 삭제 */
        ...
        if (master === "999846" || master === "981141" ) {
            ...
            commandStore.removeGlobalCommand(key);
        ...
        if (master === "999846" || master === "981141" || master === channelId) {
            ...
            commandStore.removeChannelCommand(channelId, key);
    ...
    const list = commandStore.listCommands(channelId);
    ...
    await sendChat(channelId, msg);
      ...
      /* config 명령어 */
        ...
        const reply = commandStore.getCommand(channelId, command);
