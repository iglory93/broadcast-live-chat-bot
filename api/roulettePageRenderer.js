      ...
      <head>
        ...
        <style>
          ...
          *{box-sizing:border-box;}
          ...
          .topbar h1{margin:0;font-size:34px;line-height:1.15;}
          .topbar .desc{margin-top:8px;color:var(--muted);font-size:14px;}
          ...
          .section-title .subtext{color:var(--muted);font-size:13px;line-height:1.6;}
          .label{
            display:block;
            margin-bottom:8px;
            font-size:14px;
          ...
          .button-row,.action-grid,.inline-row{display:flex;flex-wrap:wrap;gap:10px;}
          ...
          button.secondary{background:#232731;box-shadow:none;color:#f1f5f9;}
          button.ghost{background:transparent;box-shadow:none;border:1px solid var(--line-strong);color:#dce1eb;}
          button.danger{background:linear-gradient(180deg, #ff6b7f, #ef4444);box-shadow:0 14px 28px rgba(239,68,68,0.22);}
          button.small{padding:10px 14px;font-size:13px;border-radius:12px;}
          .status-badge{
            display:inline-flex;
            align-items:center;
            justify-content:center;
          ...
          .status-finished{background:rgba(74,222,128,0.14);color:#bbf7d0;border-color:rgba(74,222,128,0.28);}
          .status-closed{background:rgba(255,255,255,0.10);color:#d1d5db;border-color:rgba(255,255,255,0.12);}
          .summary-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-top:8px;}
          .summary-item{background:var(--panel-2);border:1px solid var(--line);border-radius:16px;padding:14px 16px;min-height:86px;}
          .summary-item .k{color:var(--muted);font-size:12px;font-weight:700;margin-bottom:8px;}
          .summary-item .v{font-size:18px;font-weight:900;line-height:1.35;word-break:break-word;}
          .summary-item .v.small{font-size:14px;font-weight:700;}
          .winner-card{margin-top:14px;padding:18px;border-radius:18px;border:1px solid rgba(255,209,102,0.24);background:linear-gradient(135deg, rgba(255,209,102,0.14), rgba(255,122,89,0.10));}
          .winner-card .k{color:#ffe7a0;font-size:13px;font-weight:900;margin-bottom:8px;}
          .winner-card .v{color:var(--warning);font-size:32px;font-weight:1000;line-height:1.2;word-break:keep-all;}
          .share-box,.editor-box,.search-box{margin-top:14px;padding:16px;border-radius:18px;background:var(--panel-2);border:1px solid var(--line);}
          .share-url{width:100%;border:none;outline:none;background:#0c0f14;color:#f5f7fb;border-radius:14px;padding:14px 16px;font-size:14px;font-family:monospace;border:1px solid var(--line);margin:0;}
          .share-help,.editor-help{margin-top:10px;color:var(--muted);font-size:13px;line-height:1.6;}
          .candidate-wrap{margin-top:18px;padding-top:18px;border-top:1px solid var(--line);}
          .candidate-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px;}
          .candidate-head .title{font-size:18px;font-weight:900;}
          .candidate-meta{color:var(--muted);font-size:13px;line-height:1.6;}
          .candidate-empty,.empty-state,.search-empty,.editor-empty{
            padding:16px;
            border-radius:14px;
            background:var(--panel-2);
            border:1px dashed var(--line-strong);
          ...
          .candidate-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-top:12px;}
          .candidate-item{background:#0f131b;border:1px solid var(--line);border-radius:16px;padding:14px;}
          .candidate-item-top{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;}
          .candidate-name{font-size:16px;font-weight:900;line-height:1.35;word-break:break-word;}
          .candidate-meta-line{margin-top:8px;color:var(--muted);font-size:12px;line-height:1.6;}
          .candidate-badges{display:flex;flex-wrap:wrap;gap:6px;margin-top:8px;}
          .mini-badge{display:inline-flex;align-items:center;gap:4px;padding:4px 8px;border-radius:999px;font-size:11px;font-weight:900;border:1px solid transparent;}
          .mini-live{background:rgba(74,222,128,0.12);color:#bbf7d0;border-color:rgba(74,222,128,0.18);}
          .mini-off{background:rgba(255,255,255,0.08);color:#d1d5db;border-color:rgba(255,255,255,0.12);}
          .mini-manual{background:rgba(96,165,250,0.12);color:#bfdbfe;border-color:rgba(96,165,250,0.18);}
          .checkbox-row{display:flex;align-items:flex-start;gap:10px;margin:12px 0 8px;}
          .checkbox-row input[type='checkbox']{width:18px;height:18px;margin:2px 0 0;accent-color:var(--primary);}
          .checkbox-row .checkbox-title{font-size:14px;font-weight:800;}
          .checkbox-row .checkbox-desc{font-size:12px;color:var(--muted);margin-top:2px;line-height:1.5;}
          .search-result-list{display:flex;flex-direction:column;gap:10px;margin-top:12px;}
          .search-item{background:#0f131b;border:1px solid var(--line);border-radius:16px;padding:14px;display:flex;justify-content:space-between;gap:12px;align-items:flex-start;}
          .search-item-title{font-size:16px;font-weight:900;line-height:1.35;}
          .search-item-meta{margin-top:8px;color:var(--muted);font-size:12px;line-height:1.65;}
          .live-badge{display:inline-flex;align-items:center;justify-content:center;min-width:56px;padding:4px 9px;border-radius:999px;font-size:11px;font-weight:900;margin-left:8px;}
          .live-on{background:rgba(74,222,128,0.16);color:#bbf7d0;border:1px solid rgba(74,222,128,0.22);}
          .live-off{background:rgba(255,255,255,0.10);color:#d1d5db;border:1px solid rgba(255,255,255,0.12);}
          .loading-note{margin-top:12px;color:var(--muted);font-size:13px;line-height:1.6;}
      ...
      <body>
        <div class="page">
          ...
          <div class="grid">
            <div class="card">
              <div class="section-title">
                <div>
                  <h2>이벤트 생성</h2>
                  <div class="subtext">기본은 channels에 등록된 BJ 전체를 후보로 잡습니다. 체크 시 현재 접속 중인 BJ만 후보로 만듭니다.</div>
                </div>
              </div>
              ...
              <label class="checkbox-row" for="liveOnlyCheckbox">
                <input id="liveOnlyCheckbox" type="checkbox" />
                <div>
                  <div class="checkbox-title">현재 접속한 BJ만 등록</div>
                  <div class="checkbox-desc">체크하면 지금 방송 중인 BJ만 후보에 들어갑니다. 체크하지 않으면 channels 등록 BJ 전체가 후보입니다.</div>
                </div>
              </label>
              ...
              <div class="loading-note" id="createHelp">활성 이벤트가 없거나 종료된 상태에서 새 이벤트를 만드는 흐름이 가장 안전합니다.</div>
            </div>
            ...
            <div class="card">
              ...
              <div class="share-box">
                <div class="label" style="margin-bottom:10px;">공유 링크</div>
                <input id="shareUrlInput" class="share-url" type="text" readonly value="아직 생성되지 않았습니다." />
                <div id="shareHelp" class="share-help">외부에서 열 수 있는 주소가 필요합니다. localhost 주소는 공유용으로 적합하지 않습니다.</div>
              </div>
            </div>
          </div>
          ...
          <div class="card" style="margin-top:20px;">
            <div class="section-title">
              <div>
                <h2>현재 이벤트 상태</h2>
                <div class="subtext">상태, 후보 목록, 수동 편집 영역을 한 번에 확인합니다.</div>
              </div>
            </div>
            <div id="stateBox">불러오는 중...</div>
          </div>
        ...
        <script>
          ...
          const els = {
            ...
            sponsorInput: document.getElementById('sponsorInput'),
            prizeInput: document.getElementById('prizeInput'),
            liveOnlyCheckbox: document.getElementById('liveOnlyCheckbox'),
            createBtn: document.getElementById('createBtn'),
            createHelp: document.getElementById('createHelp'),
            statusBadge: document.getElementById('statusBadge'),
            refreshCandidatesBtn: document.getElementById('refreshCandidatesBtn'),
          ...
          function getActionState(event) {
            ...
            return {
              ...
              canRedraw: hasEvent && status === 'finished',
              canClose: hasEvent && (status === 'ready' || status === 'finished'),
              canEditCandidates: hasEvent && status === 'ready'
            };
          }
          ...
          function getStateSignature(event) {
            if (!event) {
              return 'null';
            }
            ...
            return JSON.stringify({
              ...
              drawCandidateCount: event.drawCandidateCount || 0,
              winnerChannelId: event.winnerChannelId || '',
              winnerNickname: event.winnerNickname || '',
              updatedAtMs: event.updatedAtMs || 0,
              liveOnly: !!event.liveOnly,
              candidates: (Array.isArray(event.candidates) ? event.candidates : []).map(function(item) {
                return {
                  channelId: item && item.channelId || '',
                  ownerNickname: item && item.ownerNickname || '',
                  isLive: !!(item && item.isLive),
          ...
          function buildCandidateBadges(item) {
            const badges = [];
            badges.push('<span class="mini-badge ' + (item && item.isLive ? 'mini-live' : 'mini-off') + '">' + ((item && item.isLive) ? 'LIVE' : 'OFF') + '</span>');
            if (item && item.manual) {
              badges.push('<span class="mini-badge mini-manual">수동추가</span>');
            }
            return badges.join('');
          }

          function buildCandidateCard(item, editable) {
            const nickname = item && (item.ownerNickname || item.channelId) || '-';
            const channelId = item && item.channelId || '-';
            const title = item && item.title ? '<div>방제: ' + escapeHtmlClient(item.title) + '</div>' : '';
            const removeButton = editable
              ? '<button class="ghost small candidate-remove-btn" type="button" data-channel-id="' + escapeHtmlClient(channelId) + '">후보 제거</button>'
              : '';
              ...
              '<div class="candidate-item">' +
                '<div class="candidate-item-top">' +
                  '<div style="flex:1;min-width:0;">' +
                    '<div class="candidate-name">' + escapeHtmlClient(nickname) + '</div>' +
                    '<div class="candidate-badges">' + buildCandidateBadges(item) + '</div>' +
                    '<div class="candidate-meta-line">채널 ID: ' + escapeHtmlClient(channelId) + title + '</div>' +
                  '</div>' +
                  removeButton +
                '</div>' +
              '</div>';
          ...
          function renderCandidates(items, editable) {
            const candidates = Array.isArray(items) ? items : [];

            if (!candidates.length) {
              return '<div class="candidate-empty">후보가 없습니다. 대기중 상태에서 후보 새로고침 또는 수동 추가를 이용하세요.</div>';
            }

            return '<div class="candidate-list">' + candidates.map(function(item) {
              return buildCandidateCard(item, editable);
            }).join('') + '</div>';
          }

          function renderCandidateEditor(event) {
            ...
            if (!state.canEditCandidates) {
              return '<div class="editor-box"><div class="editor-help">후보 수동 추가/제거는 대기중 상태에서만 가능합니다. 감속중/진행중에는 고정됩니다.</div></div>';
            }
            ...
            return '' +
              '<div class="editor-box">' +
                '<div class="section-title" style="margin-bottom:12px;">' +
                  '<div>' +
                    '<div style="font-size:18px;font-weight:900;">후보 수동 편집</div>' +
                    '<div class="editor-help" style="margin-top:6px;">닉네임은 DB에 저장하지 않고, 화면 표시 시점에만 조회합니다. 후보 저장은 channelId 기준으로만 처리됩니다.</div>' +
                  '</div>' +
                '</div>' +
                '<div class="search-box" style="margin-top:0;">' +
                  '<label class="label" for="candidateSearchInput">BJ 검색 후 후보 추가</label>' +
                  '<div class="inline-row">' +
                    '<input id="candidateSearchInput" type="text" placeholder="BJ명 또는 채널명을 입력하세요. 예) 퐁이" style="margin:0;flex:1;min-width:220px;" />' +
                    '<button id="candidateSearchBtn" type="button">검색</button>' +
                  '</div>' +
                  '<div id="candidateSearchResult" class="search-result-list"><div class="search-empty">검색어를 입력한 뒤 후보를 추가하세요.</div></div>' +
                '</div>' +
              '</div>';
          }

          function renderState(event) {
            lastStateSignature = getStateSignature(event);
            updateStatusBadge(event);

            if (!event) {
              els.stateBox.innerHTML = '<div class="empty-state">현재 활성 이벤트가 없습니다. 새 이벤트를 생성하면 이 영역에 상태와 후보 목록이 표시됩니다.</div>';
              bindStateActions();
              updateActionButtons();
              return;
            }
            ...
            const modeText = event.candidateModeText || (event.liveOnly ? '현재 접속 BJ만' : 'channels 등록 BJ 전체');
            ...
            els.stateBox.innerHTML = '' +
              '<div class="summary-grid">' +
                ...
                '<div class="summary-item"><div class="k">상태</div><div class="v">' + escapeHtmlClient(getStatusText(status)) + '</div></div>' +
                '<div class="summary-item"><div class="k">이벤트명</div><div class="v">' + escapeHtmlClient(event.title || '-') + '</div></div>' +
                '<div class="summary-item"><div class="k">후보 생성 기준</div><div class="v">' + escapeHtmlClient(modeText) + '</div></div>' +
                '<div class="summary-item"><div class="k">펀딩 담당자</div><div class="v">' + escapeHtmlClient(event.sponsorName || '-') + '</div></div>' +
                '<div class="summary-item"><div class="k">상품 / 금액</div><div class="v">' + escapeHtmlClient(event.prizeText || '-') + '</div></div>' +
                '<div class="summary-item"><div class="k">후보 수</div><div class="v">' + candidateCount + (candidateCount !== currentCandidateCount ? ' <span style="font-size:12px;color:#98a2b3;font-weight:700;">(현재 후보 ' + currentCandidateCount + '명)</span>' : '') + '</div></div>' +
                '<div class="summary-item"><div class="k">수동 편집 가능</div><div class="v">' + (editable ? '가능' : '잠김') + '</div></div>' +
              '</div>' +
              winnerHtml +
              '<div class="candidate-wrap">' +
                '<div class="candidate-head">' +
                  '<div class="title">후보 목록</div>' +
                  '<div class="candidate-meta">대기중 상태에서는 후보를 수동으로 추가/제거할 수 있습니다.</div>' +
                '</div>' +
                renderCandidates(event.candidates || [], editable) +
              '</div>' +
              renderCandidateEditor(event);
          ...
          async function loadCurrent() {
            ...
            const nextSignature = getStateSignature(nextEvent);
          ...
          async function performCandidateSearch(keepInputFocus) {
            const input = document.getElementById('candidateSearchInput');
            const resultBox = document.getElementById('candidateSearchResult');
            const button = document.getElementById('candidateSearchBtn');
            ...
            if (!q) {
              resultBox.innerHTML = '<div class="search-empty">검색어를 입력해주세요.</div>';
              if (keepInputFocus) {
                input.focus();
              }
              return;
            ...
            resultBox.innerHTML = '<div class="search-empty">검색 중...</div>';
            ...
            try {
              ...
              const candidateIdSet = new Set((Array.isArray(currentEvent && currentEvent.candidates) ? currentEvent.candidates : []).map(function(item) {
                return String(item && item.channelId || '');
              }));
              ...
              resultBox.innerHTML = items.map(function(item) {
                ...
                const alreadyIncluded = candidateIdSet.has(channelId);
                const actionButton = alreadyIncluded
                  ? '<button class="secondary small" type="button" disabled>이미 포함됨</button>'
                  : '<button class="small candidate-add-btn" type="button" data-channel-id="' + escapeHtmlClient(channelId) + '">후보 추가</button>';

                return '' +
                  '<div class="search-item">' +
                    '<div style="flex:1;min-width:0;">' +
                      '<div class="search-item-title">' + escapeHtmlClient(item.channelName || item.ownerNickname || '-') +
                        '<span class="live-badge ' + (item.isInLive ? 'live-on' : 'live-off') + '">' + (item.isInLive ? 'LIVE' : 'OFF') + '</span>' +
                      '</div>' +
                      '<div class="search-item-meta">채널 ID: ' + escapeHtmlClient(channelId || '-') + '<br/>BJ: ' + escapeHtmlClient(item.ownerNickname || '-') + '<br/>로그인 ID: ' + escapeHtmlClient(item.loginId || '-') + '<br/>시청자 수: ' + Number(item.playerCount || 0) + '</div>' +
                    '</div>' +
              ...
              resultBox.innerHTML = '<div class="search-empty">검색 실패: ' + escapeHtmlClient(err.message || 'unknown') + '</div>';
            } finally {
              button.disabled = false;
            }
          }

          function bindCandidateRemoveButtons() {
            const buttons = els.stateBox.querySelectorAll('.candidate-remove-btn[data-channel-id]');

            buttons.forEach(function(button) {
              button.addEventListener('click', function() {
                const channelId = String(button.dataset.channelId || '');

                if (!currentEvent || !currentEvent.id || !channelId) {
                  return;
                }

                withAction(async function() {
                  const data = await postJson('/dashboard/api/roulette/' + encodeURIComponent(currentEvent.id) + '/candidates/remove', {
                    channelId: channelId
                  });
          ...
          function bindCandidateAddButtons() {
            ...
            const buttons = resultBox.querySelectorAll('.candidate-add-btn[data-channel-id]');
            ...
            buttons.forEach(function(button) {
              button.addEventListener('click', function() {
                ...
                withAction(async function() {
                  const data = await postJson('/dashboard/api/roulette/' + encodeURIComponent(currentEvent.id) + '/candidates/add', {
                    channelId: channelId
                  });
                  ...
                  currentEvent = data.event || null;
                  renderState(currentEvent);
                  await performCandidateSearch(false);
                }).catch(function(err) {
                  alert('후보 추가 실패: ' + err.message);
                });
              });
            });
          }
          ...
          function bindStateActions() {
            bindCandidateRemoveButtons();

            const searchBtn = document.getElementById('candidateSearchBtn');
            const searchInput = document.getElementById('candidateSearchInput');

            if (searchBtn) {
              searchBtn.addEventListener('click', function() {
                performCandidateSearch(false);
              });
            }
          ...
          els.createBtn.addEventListener('click', function() {
            withAction(async function() {
              ...
              const sponsorName = els.sponsorInput.value.trim();
              const prizeText = els.prizeInput.value.trim();
              const liveOnly = !!els.liveOnlyCheckbox.checked;
